...
<html>
  <head>
    ...
    <title>Licoreria | By Wilde</title>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Wilde Valdez</span>
                </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ route('articulo.index') }}"><i class="fa fa-circle-o"></i> Productos </a></li>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Licoreria "Super originales"</h3>
